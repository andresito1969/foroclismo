...
trait ErrorTextTrait {
    ...
    public function getBannedUser($email) {
        return $email . ' ha sido baneado satisfactoriamente';
    }

    public function getUnBannedUser($email) {
        return $email . ' ha sido desbaneado satisfactoriamente';
    }
}